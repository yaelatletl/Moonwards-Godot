...
var _selected_mat : SpatialMaterial = load("res://Trees/Interface/MainMenu/OptionsOld/selected.material")
var _unselected_mat : SpatialMaterial = load("res://Trees/Interface/MainMenu/OptionsOld/unselected.material")
