...
var _selected_mat : SpatialMaterial = load("res://Interface/MainMenu/OptionsOld/selected.material")
var _unselected_mat : SpatialMaterial = load("res://Interface/MainMenu/OptionsOld/unselected.material")
